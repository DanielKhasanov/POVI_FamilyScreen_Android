 ...
 * the measure pass.
 */
public class WrapLayoutManager extends android.support.v7.widget.LinearLayoutManager {

    private static final int CHILD_WIDTH = 0;
    private static final int CHILD_HEIGHT = 1;
    private static final int DEFAULT_CHILD_SIZE = 100;
    private static final int DEFAULT_CHILD_CAP = 5;

    private final int[] childDimensions = new int[2];

    private int childSize = DEFAULT_CHILD_SIZE;
    private boolean hasChildSize;
    private int childCap = DEFAULT_CHILD_CAP;
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        final int adapterItemCount = Math.min(getItemCount(), childCap);
    ...
    private void logMeasureWarning(int child) {
        if (BuildConfig.DEBUG) {
            Log.w("WrapLayoutManager", "Can't measure child #" + child + ", previously used dimensions will be reused." +
    ...
    public void setChildCap(int childMax) {
        childCap = childMax;
    }
